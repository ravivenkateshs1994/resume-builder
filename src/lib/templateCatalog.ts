...
export const TEMPLATE_CATALOG: TemplateCatalogItem[] = ([
  ...
  },
  {
    id: "pinnacle",
    name: "Pinnacle",
    thumbnailUrl: `${BASE_THUMBNAIL}/pinnacle.jpg`,
    description: "Centred-header prestige format. Harvard Business School & Big-4 inspired serif layout — the gold standard for consulting, finance, and executive roles.",
    style: "Centred serif with small-caps section rules and clean dot-separated contact line.",
    previewColor: "bg-blue-900",
    category: "professional",
    tags: ["ATS Optimized", "Premium", "Finance"],
    atsScore: 97,
    recommendedRoles: ["Management Consultant", "Investment Banker", "VP Strategy", "Chief of Staff", "Corporate Attorney"],
    recommendedFor: ["Management Consultant", "Investment Banker", "Finance Director"],
    recommendedIndustries: ["Consulting", "Investment Banking", "Private Equity", "Law", "Enterprise"],
    isPremium: true,
    premiumBadgeType: "Premium",
    priceModel: "premium",
    roleCategory: "leadership",
  ...
  },
  {
    id: "vector",
    name: "Vector",
    thumbnailUrl: `${BASE_THUMBNAIL}/vector.jpg`,
    description: "FAANG-grade left-accent layout used by top tech recruiters. Clean information density, inline accent rule headings, and plain-text skills for maximum ATS parse accuracy.",
    style: "Left accent-bar header, inline rule sections, plain-text skill list.",
    previewColor: "bg-teal-700",
    category: "ats",
    tags: ["ATS Optimized", "Premium", "Tech"],
    atsScore: 97,
    recommendedRoles: ["Senior Software Engineer", "Staff Engineer", "Engineering Manager", "Principal Architect", "ML Engineer"],
    recommendedFor: ["Senior Software Engineer", "Engineering Manager", "ML Engineer"],
    recommendedIndustries: ["Big Tech", "AI", "Cloud", "FinTech", "Developer Tools"],
    isPremium: true,
    premiumBadgeType: "Premium",
    priceModel: "premium",
    roleCategory: "software",
